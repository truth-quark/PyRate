...
#         """ """
#         self.assertRaises(ReferencePhaseError, process._ref_phase_estimation, self.ifgs[:1], self.params, self.refpx,
#                           self.refpy)
#
...
#         self.assertRaises(CorrectionStatusError, process._ref_phase_estimation, self.ifgs, self.params, self.refpx,
#                           self.refpy)
#
#
...
#
#         onlyfiles = [f for f in os.listdir(LEGACY_REF_PHASE_DIR) if
#                      os.path.isfile(os.path.join(LEGACY_REF_PHASE_DIR, f)) and f.endswith('.csv') and f.__contains__(
#                          '_ref_phase_')]
#
#         count = 0
...
#         onlyfiles = [f for f in os.listdir(LEGACY_REF_PHASE_DIR) if
#                      os.path.isfile(os.path.join(LEGACY_REF_PHASE_DIR, f)) and f.endswith('.csv') and f.__contains__(
#                          '_ref_phase_') and f.__contains__('method2')]
#
#         count = 0
#         for i, f in enumerate(onlyfiles):
#             ifg_data = np.genfromtxt(os.path.join(
