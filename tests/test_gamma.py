...
class GammaToGeoTiffTests(unittest.TestCase):
    ...
    def test_to_geotiff_dem(self):
        ...
        assert_array_almost_equal(np.rint(exp_ds.ReadAsArray()), ds.ReadAsArray())
    ...
    def test_bad_projection(self):
        ...
        self.assertRaises(GeotiffException, write_fullres_geotiff, hdr, data_path, self.dest, nodata=0)
...
class GammaHeaderParsingTests(unittest.TestCase):
    ...
    def test_parse_gamma_epoch_header(self):
        ...
        exp_wavelen = LIGHTSPEED / 5.3310040e09
...
H0 = {
    ifc.MASTER_DATE: date(2009, 7, 13),
...
H1 = {
    ifc.MASTER_DATE: date(2009, 8, 17),
